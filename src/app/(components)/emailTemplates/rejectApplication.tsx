...
export const EmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  <div style={{ width: "100%" }}>
    ...
    <main
      ...
      alignItems: "center",
      justifyContent: "center",
      flexDirection: "column", paddingRight: "20px" }}
    >
      <h2 style={{ color: "#4A5568",textAlign: "center", }}>Hello {firstName}!</h2>
      <p style={{ marginTop: "8px", lineHeight: "1.75", color: "#718096",textAlign: "center", }}>
        {subject}.
      </p>
      <p style={{ marginTop: "8px", lineHeight: "1.75", color: "#718096",textAlign: "center", }}>
        {message}.
