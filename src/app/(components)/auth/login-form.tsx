...
const LoginForm = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-white w-full">
      <Link
        href="/"
        className="flex items-center space-x-3 rtl:space-x-reverse my-3"
      >
        <Image
          src="/logo/logooo.png"
          className="h-auto"
          ...
          >
            ...
            <div className="flex flex-col space-y-2">
              <button
                ...
                className={` ${
                  pending || !form.formState.isValid
                    ? "cursor-not-allowed opacity-40"
                    : ""
                } w-full text-white bg-blue-700 hover:bg-blue-500 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center`}
              >
                Login
              </button>
              <Link
                className="forgot-password flex text-blue-600 hover:text-blue-500 text-sm justify-end"
